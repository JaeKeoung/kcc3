                        ...
                        <table id="view">
                            ...
                            <tr class="view_tr">
                                <div class="td_wrap">
                                    ...
                                    <td id="view_count">조회수 : <?=$data['Count']?></td>
                                </div>
                            </tr>
                            <tr class="content">
                                <td><?=$data['Content']?></td>
                                <td><a href="/fup/<?=$data['file_enc']?>" download="<?=$data['upload']?>"><?=$data['upload']?></a></td>
                            </tr>
                        </table>
					</div>
				</div>
