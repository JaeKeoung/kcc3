					...
					<div class="article_box">
						...
						<div class="enter_area">
							...
							<tr>
								...
								<td>
                                                                    <input type="text" id="sample6_postcode" placeholder="우편번호" name="homePostNumber">
                                                                    <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
                                                                    <input type="text" id="sample6_address" placeholder="주소" name="homeAdress">
                                                                    <input type="text" id="sample6_address2" placeholder="상세주소" name="homeDetailAdress">
								</td>
							</tr>
							<tr>
						...
						<fieldset>
							...
							<tr>
								...
								<td>
                                                                    <input type="text" id="sample6_postcode" placeholder="우편번호" name="companyPostNumber">
                                                                    <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
                                                                    <input type="text" id="sample6_address" placeholder="주소" name="companyAdress">
                                                                    <input type="text" id="sample6_address2" placeholder="상세주소" name="conpanyDetailAdress">
								</td>
							</tr>
							<tr>
